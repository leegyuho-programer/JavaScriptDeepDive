...
<details>
<summary>😀표준 빌트인 생성자 함수와 빌트인 메서드😀</summary>

<!--summary 아래 빈칸 공백 두고 내용을 적는공간-->
표준 빌트인 생성자 함수와 표준 빌트인 메서드는 자바스크립트에서 기본 제공하는 함수이다. 표준 빌트인 생성자 함수는 객체를 생성하지 위한 함수이며 new 연산자와 함께 호출한다. 표준 빌트인 메서드는 자바스크립트에서 기본 제공하는 빌트인 객체의 메서드다.
</details>
